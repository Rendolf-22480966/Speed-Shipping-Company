...
DEFAULT_VAULTS = {
    'CG201609SP': {
        ...
        'account_status': 'Partial Clearance · Rollover Protection Active',
        'account_status_class': 'past-due',
        'clearance_assessment': '£20,375.00',
        'outstanding_clearance_fee': '£10,525.00',
        'valuation_reference': '$12.7 Million',
        'recent_payment_date': '27 June 2026',
        'recent_payment_amount': '£9,850.00',
        'recent_payment_mode': 'Cash',
        'recent_payment_source': 'Cash · Received at Speed-Shipping Secure Vault',
        'receipt_number': 'SSSC-RCPT-20260627-9850',
        'initial_payment_date': '16 January 2016',
        'initial_payment_source': 'Bank of America',
        'initial_receipt_number': '367954091112',
